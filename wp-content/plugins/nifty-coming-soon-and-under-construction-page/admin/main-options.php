    ...
    'settings'        => array( 
      ...
      array(
	   ...
	   array(
        ...
        'label'       => 'Insert Additional CSS',
        'desc'        => 'Here you can enter your custom CSS code that can override theme default classes, just remember to add !important at the end of your CSS statements.</br></br>See example below:</br></br><pre>.nifty-coming-soon-message {font-size: 3em !important;}</pre>',
        'std'         => '',
        'type'        => 'css',
        'section'     => 'general_settings',
        'min_max_step'=> '',
